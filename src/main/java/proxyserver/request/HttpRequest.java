...
public class HttpRequest {
    ...
    public HttpResponse execute() {
        return execute(requestBuilder.getHost(), requestBuilder.getPort());
    }

    public HttpResponse execute(String host, int port) {
        Socket client = SocketUtil.createSocket(host, port);
